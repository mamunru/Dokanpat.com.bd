...
class _ProductDetailsState extends State<ProductDetails> {
  ...
  void initState() {
    ...
    if (product.variationProducts != null) {
      ...
      // var e = product.variationProducts![0];
      // //productModel product = pcontroller.productinfo!;

      // /// print('====== veriation call=======' + product.price.toString());
      // setState(() {
      //   product.price = e.price;
      //   product.regularPrice = e.regularPrice;
      //   vid = e.id!;
      //   variation_value = e.attributesArr![0].attributeName.toString();
      //   src = e.featureImage.toString();
      // });
    }
  ...
  void scrollevent() {
    ...
    ProductFilterController productcontroller = Get.find();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GetBuilder<ProductFilterController>(builder: (pcontroller) {
        //productModel product = pcontroller.productinfo!;
        return Stack(
          children: [
            CustomScrollView(
                ...
                SliverToBoxAdapter(
                  child: Column(
                    ...
                    children: [
                      ...
                      GetBuilder<ProductFilterController>(
